...
| --- | --- | --- | --- | --- | --- |
| [Vercel Hobby](https://vercel.com/docs/plans/hobby) | Ongoing free allowance | 100 GB Fast Data Transfer; included serverless functions | Hobby is restricted to personal, non-commercial projects; usage caps pause services. | Not required | Restricted / personal use |
| [Netlify Free](https://www.netlify.com/pricing/) | Ongoing free allowance | 300 credits/month on new credit-based plans; custom domains and SSL | Production deploys, requests, bandwidth and compute all consume credits; legacy accounts may differ. | Not required | Check provider |
| [Cloudflare Pages](https://developers.cloudflare.com/pages/platform/limits/) | Ongoing free allowance | 500 builds/month; up to 20,000 files/site on Free | Pages Functions consume the separate Workers quota; 20-minute build timeout. | Not required | Check provider |
| [GitHub Pages](https://docs.github.com/en/pages/getting-started-with-github-pages/github-pages-limits) | Ongoing free allowance | Static sites from public repositories; 1 GB site limit; ~100 GB/month soft bandwidth | Not permitted as free hosting for an online business, e-commerce site or commercial SaaS. | Not required | Restricted / personal use |
